...
export type ChatbotRecommendationE2eCase = {
  ...
  /** Cụm ngành kỳ vọng đưa vào RecommendationsService.interests */
  ...
  /** Ollama hay ghi đè entity major sai */

  ollama_major_conflict?: string;
};

export const CHATBOT_RECOMMENDATION_E2E_CASES: ChatbotRecommendationE2eCase[] =
  [
    {
