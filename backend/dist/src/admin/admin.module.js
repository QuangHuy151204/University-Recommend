...
const admin_config_module_1 = require("./admin-config.module");
...
exports.AdminModule = AdminModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([university_entity_1.University, major_entity_1.Major, cutoff_score_entity_1.CutoffScore, user_entity_1.User]),
