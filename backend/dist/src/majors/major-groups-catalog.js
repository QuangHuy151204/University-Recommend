...
exports.KHAC_GROUP_NAME = exports.KHAC_GROUP_ID = exports.MAJOR_GROUP_BY_NAME = exports.MAJOR_GROUP_BY_ID = exports.MAJOR_GROUPS = void 0;
exports.MAJOR_GROUPS = [
    {
...
exports.MAJOR_GROUP_BY_ID = new Map(exports.MAJOR_GROUPS.map((g) => [g.group_id, g]));
exports.MAJOR_GROUP_BY_NAME = new Map(exports.MAJOR_GROUPS.map((g) => [g.group_name, g]));
exports.KHAC_GROUP_ID = 'khac';
exports.KHAC_GROUP_NAME = 'Khác';
//# sourceMappingURL=major-groups-catalog.js.map